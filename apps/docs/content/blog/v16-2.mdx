...
**Migration Steps:** Update your imports accordingly. Although the default `xyzdoc-ui/page` will redirect to the correct layout, we strongly advise explicit imports for clarity and future-proofing.
...
The `xyzdoc-ui/contexts/sidebar` module has been removed. Access the context via:

```ts
import { useSidebar } from 'xyzdoc-ui/components/sidebar/base';
```
