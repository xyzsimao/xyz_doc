...
import browserCollections from 'xyzdoc-mdx:collections/browser';
...
```ts
import { blogPosts } from 'xyzdoc-mdx:collections/server';
...
```ts tab="Before"
import { postInstall } from 'xyzdoc-mdx/next';
// or
import { postInstall } from 'xyzdoc-mdx/vite';
...
import { defineCollections, getDefaultMDXOptions } from 'xyzdoc-mdx/config';
