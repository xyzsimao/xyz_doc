...
import { defineI18n } from 'xyzdoc-core/i18n';
...
import { defineI18nUI } from 'xyzdoc-ui/i18n';
...
import { i18n } from '@/lib/i18n';
import type { BaseLayoutProps } from 'xyzdoc-ui/layouts/shared';
...
In addition, the [`xyzdoc-core/dynamic-link`](/docs/headless/components/link#dynamic-hrefs) component supports dynamic hrefs, you can use it to attend the locale prefix.
It is useful for Markdown/MDX content.

```mdx title="content.mdx"
import { DynamicLink } from 'xyzdoc-core/dynamic-link';
