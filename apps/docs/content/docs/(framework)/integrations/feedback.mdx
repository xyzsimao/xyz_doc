...
```npm
npx @xyzdoc/cli@latest add feedback
```
...
```tsx
import { DocsPage } from 'xyzdoc-ui/layout/docs/page';
...
import { remarkFeedbackBlock } from 'xyzdoc-core/mdx-plugins/remark-feedback-block';
