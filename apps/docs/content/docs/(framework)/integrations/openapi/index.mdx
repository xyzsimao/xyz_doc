...
import { openapiPlugin } from 'xyzdoc-openapi/server';
...
import { loader, multiple } from 'xyzdoc-core/source';
import { openapiPlugin, openapiSource } from 'xyzdoc-openapi/server';
import { docs } from 'xyzdoc-mdx:collections/server';
import { openapi } from '@/lib/openapi';
...
import type { InferPageType } from 'xyzdoc-core/source';
