...
import { rewritePath } from 'xyzdoc-core/negotiation';
...
import { isMarkdownPreferred, rewritePath } from 'xyzdoc-core/negotiation';
...
```npm
npx @xyzdoc/cli add ai/page-actions
```
