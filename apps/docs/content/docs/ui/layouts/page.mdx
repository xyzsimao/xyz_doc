...
import { DocsPage, DocsDescription, DocsTitle, DocsBody } from 'xyzdoc-ui/layouts/docs/page';
...
import { DocsPage, DocsDescription, DocsTitle, DocsBody } from 'xyzdoc-ui/layouts/notebook/page';
...
```tsx
// docs layout:
import { DocsPage } from 'xyzdoc-ui/layouts/docs/page';
// notebook layout:
import { DocsPage } from 'xyzdoc-ui/layouts/notebook/page';
...
```tsx
// docs layout:
import { DocsPage, PageLastUpdate } from 'xyzdoc-ui/layouts/docs/page';
// notebook layout:
import { DocsPage, PageLastUpdate } from 'xyzdoc-ui/layouts/notebook/page';
...
```tsx
import { getGithubLastEdit } from 'xyzdoc-core/content/github';
