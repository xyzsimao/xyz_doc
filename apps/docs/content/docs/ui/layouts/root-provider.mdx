...
import { RootProvider } from 'xyzdoc-ui/provider/react-router';
...
import { RootProvider } from 'xyzdoc-ui/provider/tanstack';
...
```jsx tab="Waku"
import { RootProvider } from 'xyzdoc-ui/provider/waku';
