...
```package-install
npx @xyzdoc/cli add banner files
```
...
```package-install
npx @xyzdoc/cli tree ./my-dir ./output.tsx
```

You can output MDX files too:

```package-install
npx @xyzdoc/cli tree ./my-dir ./output.mdx
```

See help for further details:

```package-install
npx @xyzdoc/cli tree -h
```

#### Example Output

```tsx title="output.tsx"
import { File, Folder, Files } from 'xyzdoc-ui/components/files';
