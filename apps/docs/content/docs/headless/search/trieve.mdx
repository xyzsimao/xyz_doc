...
```package-install
trieve-ts-sdk trieve-xyzdoc-adapter
```
...
import { type TrieveDocument } from 'trieve-xyzdoc-adapter/search/sync';
...
import { sync, type TrieveDocument } from 'trieve-xyzdoc-adapter/search/sync';
...
'use client';
import type { SharedProps } from 'xyzdoc-ui/components/dialog/search';
import SearchDialog from 'trieve-xyzdoc-adapter/components/dialog/search';
import { TrieveSDK } from 'trieve-ts-sdk';
...
```ts
import { TrieveSDK } from 'trieve-ts-sdk';
import { useTrieveSearch } from 'trieve-xyzdoc-adapter/search/trieve';
...
```js
import { sync } from 'trieve-xyzdoc-adapter/search/sync';
import { TrieveSDK } from 'trieve-ts-sdk';
