...
import { createSearchAPI } from 'xyzdoc-core/search/server';
...
<auto-type-table type='Extract<import("xyzdoc-core/search/client").Client, { type: "fetch" }>' />
...
- **Search Client**: use `static` instead of `fetch`.
  ...
  <auto-type-table type='Extract<import("xyzdoc-core/search/client").Client, { type: "static" }>' />
...
import { source } from '@/lib/source';
import { createI18nSearchAPI } from 'xyzdoc-core/search/server';
...
```ts
import { initAdvancedSearch } from 'xyzdoc-core/search/server';
