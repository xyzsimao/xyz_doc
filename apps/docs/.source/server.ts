...
import * as __fd_glob_3 from "../content/docs/(framework)/index.mdx?collection=docs"
...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_0, "cli/meta.json": __fd_glob_1, "ui/meta.json": __fd_glob_2, }, {"(framework)/index.mdx": __fd_glob_3, "cli/create-fumadocs-app.mdx": __fd_glob_4, "cli/index.mdx": __fd_glob_5, "markdown/mdx.mdx": __fd_glob_6, "ui/components/accordion.mdx": __fd_glob_7, });