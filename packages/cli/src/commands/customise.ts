...
export async function customise(client: RegistryClient) {
  ...
  if (result.target === 'docs') {
    ...
    const maps: [string, string][] =
      result.mode === 'full-notebook'
        ? [
            ['xyzdoc-ui/layouts/notebook', '@/components/layout/notebook'],
            ['xyzdoc-ui/layouts/notebook/page', '@/components/layout/notebook/page'],
          ]
        : [
            ['xyzdoc-ui/layouts/docs', '@/components/layout/docs'],
            ['xyzdoc-ui/layouts/docs/page', '@/components/layout/docs/page'],
          ];
  ...
  if (result.target === 'home') {
    ...
    printNext(['xyzdoc-ui/layouts/home', `@/components/layout/home`]);
  }
