...
import { DynamicCodeBlock } from 'xyzdoc-ui/components/dynamic-codeblock';
...
import {
  ...
  CollapsibleContent,
  CollapsibleTrigger,
} from 'xyzdoc-ui/components/ui/collapsible';
...
export interface PlaygroundClientOptions {
   ...
   * - the library itself, with types from `xyzdoc-openapi/playground/client`.
   * - the `Custom.useController()` from `xyzdoc-openapi/playground/client`.
   *
